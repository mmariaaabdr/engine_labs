...
def readIntensity(photoName, plotName, lamp, surface):
    ...
    background = photo[440:840 ,760:965, 0:3].swapaxes(0, 1)
    cut = photo[440:840 ,760:965, 0:3].swapaxes(0, 1)
...
intensity = readIntensity(
    photoName='white.jpg',   # Имя файла с изображением
    plotName='plot_white.png',      # Имя файла для сохранения графика
