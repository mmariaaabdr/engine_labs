...
def readIntensity(photoName, plotName, lamp, surface):
    ...
    background = photo[450:840 ,760:965, 0:3].swapaxes(0, 1)
    cut = photo[450:840 ,760:965, 0:3].swapaxes(0, 1)
...
intensity = readIntensity(
    photoName='yellow.jpg',   # Имя файла с изображением
    plotName='plot_yellow.png',      # Имя файла для сохранения графика
    lamp='Лампа накаливания', # Тип лампы
    surface='Желтая бумага'   # Тип поверхности
)