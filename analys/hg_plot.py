...
def readIntensity(photoName, plotName, lamp, surface):
    ...
    background = photo[490:780 ,770:955, 0:3].swapaxes(0, 1)  # Исправлены индексы среза
    cut = photo[490:780 ,770:955, 0:3].swapaxes(0, 1)  # Исправлены индексы среза
...
intensity = readIntensity(
    photoName='hg.jpg',   # Имя файла с изображением
    plotName='plot_hg.png',      # Имя файла для сохранения графика
    lamp='Какая-то лампа накаливания', # Тип лампы
    surface='Какая-то бумага'   # Тип поверхности
)